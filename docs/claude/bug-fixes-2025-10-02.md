...
### Bug Description
- **File:** `python/cocoindex_code_mcp_server/backends/postgres_backend.py:237`
...
### Bug Description
- **File:** `python/cocoindex_code_mcp_server/language_handlers/rust_visitor.py`
...
### Fix Applied
Added Rust-specific node types to `python/cocoindex_code_mcp_server/ast_visitor.py:304-316`:
...
1. `/workspaces/rust/python/cocoindex_code_mcp_server/backends/postgres_backend.py`
   - Line 237: Updated hybrid_score formula
   - Line 245: Added keyword_weight parameter

2. `/workspaces/rust/python/cocoindex_code_mcp_server/ast_visitor.py`
