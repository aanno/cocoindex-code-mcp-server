...
@patch('cocoindex_code_mcp_server.hybrid_search.register_vector')
class TestHybridSearchEngine:
    ...
    @patch('cocoindex_code_mcp_server.hybrid_search.KeywordSearchParser')
    @patch('cocoindex_code_mcp_server.hybrid_search.cocoindex.utils.get_target_default_name')
    @patch('cocoindex_code_mcp_server.hybrid_search.code_to_embedding')
